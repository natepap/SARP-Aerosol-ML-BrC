...
for old analysis and input, as well as plotting flight paths
"""
...
def plotFlightMap(dataList):
    ...
    # creates nan list of flight locations for a single old dict at a time
